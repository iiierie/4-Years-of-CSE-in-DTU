...
1. outer loop for total passes from 0 to n-1 
  2. inner loop for each passes from 0 to n-1-i (harek ptk ghatdai janxa cause list ko last element ma obviously highest store vaisakeko hunxa so patak patak check nagrne )
