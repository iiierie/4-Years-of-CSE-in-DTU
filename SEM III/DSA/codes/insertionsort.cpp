...
// yo sorting ma chai sorted ra unsorted array maintain 
// unsorted ko element lai sorted ko harek snga compare to see if it is grater or smaller and then keep it in its respective place 
